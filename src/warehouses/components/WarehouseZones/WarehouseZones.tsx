...
import { WarehouseDetails_warehouse_shippingZones_edges_node } from "@dastkari/warehouses/types/WarehouseDetails";
import { renderCollection, maybe } from "@dastkari/misc";
import Link from "@dastkari/components/Link";
